...
public class FavoriController {
    ...
    public ResponseEntity<Favori> addFavori(@PathVariable("destinationId") Long destinationId) {
        return ResponseEntity.ok(favoriService.addFavori(destinationId));
    }

    @DeleteMapping("/{destinationId}")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Void> removeFavori(@PathVariable("destinationId") Long destinationId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<Boolean> isFavori(@PathVariable("destinationId") Long destinationId) {
